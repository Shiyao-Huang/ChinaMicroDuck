...
| [09-总清单](09-总清单.md) | 一页纸：资产统计/验证矩阵/决策待办/风险 | **给筛选会** |
| [10-强化学习训练步骤](10-强化学习训练步骤.md) | 官方 7 步法 + 奖励设计教训 + 本机实测 | **训练前必读** |
| [11-官方仓硬件资产完整复盘](11-官方仓硬件资产完整复盘.md) | 官方仓逐文件扫描：12 项可直接复用资产 + 10 项缺口 + 2 个认知修正 | **越接近原始越容易成功** |
